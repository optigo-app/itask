...
import { formatDate, formatDate2, getRandomAvatarColor, getStatusColor, mapKeyValuePair, priorityColors } from "../../../Utils/globalfun";
    ...
    try {
      ...
      if (parentId && String(parentId) !== '0') {
        ...
        try {
          ...
          console.error('Error fetching data for parent estimation before project kanban delete:', err);
        }
      }
      ...
      if (deleteTaskApi && deleteTaskApi?.rd[0]?.stat == 1) {
        if (parentSumSplitestimate) {
          try {
            ...
            console.error('Error updating parent estimate after project kanban delete:', err);
          }
        }
