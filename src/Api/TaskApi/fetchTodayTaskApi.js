...
export const fetchTodayTaskApi = async (orderBy = "order by FullPath asc", pageSize = "100", currentPage = "1", filter = {}) => {
    ...
    try {
        ...
        const body = {
            "con": `{\"id\":\"\",\"mode\":\"TREELIST_Today\",\"appuserid\":\"${AuthData?.uid ?? ''}\",\"IPAddress\":\"${ipAddress}\"}`,
